...
public class OrgControllerTest {
    ...
    public void shouldCreateOrg() {//positive case
        ...
        NeighborOrgEntity expectedOrg = new NeighborOrgEntity();
        expectedOrg.setExtId("unique_id");
        expectedOrg.setName("org_name");
        expectedOrg.setActive(true);
        Optional<NeighborOrgEntity> actualOrg = orgRepository.findByExtId(org.getExtId());
        ...
        NeighborAccountEntity actualAccount = accountRepository.findDefaultByOrgIdAndOwnerPhone(actualOrg.get().getId(), "0");

        NeighborAccountEntity expectedAccount = accountService.defaultForOrg(actualOrg.get());
    ...
    public void shouldUpdateExistingOrg() {
        ...
        Optional<NeighborOrgEntity> foundedOrg = orgRepository.findByExtId(updateOrgRequest.getExtId());
        assertTrue("should have org", foundedOrg.isPresent());
        NeighborOrgEntity actualOrg = foundedOrg.get();
        NeighborOrgEntity expectedOrg = new NeighborOrgEntity();
    ...
    public void shouldNotDeleteOrgIfAccountsExist() {
        String extId = "org_to_delete";
        persistOrg(extId);
        Optional<NeighborOrgEntity> foundedOrg = orgRepository.findByExtId(extId);
